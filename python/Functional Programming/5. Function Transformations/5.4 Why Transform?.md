...
def formatter(pattern: str) -> Callable[[int], int]:
...
## Closures
90% of the time, when I use function transformations, it's because I want to create a closure. We'll take about closures in the next chapter!
