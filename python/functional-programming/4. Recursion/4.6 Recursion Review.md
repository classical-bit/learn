...
I most often use recursion on tree-like problems (file systems, nested directories, etc.). If I'm just iterating over a one-dimensional list, then a loop is typically simpler, even if it's not as "pure" in the academic sense.
