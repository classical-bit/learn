...
There's nothing worse than trying to debug a program where the order of function calls needs to be just right because they all read and modify the same global variable.
