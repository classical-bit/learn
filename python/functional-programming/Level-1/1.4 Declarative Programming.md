...
Let's take an extreme example and pretend we wanted to style a webpage with CSS. (Obviously hypothetical because, well, why would anyone want to work on the frontend???)
